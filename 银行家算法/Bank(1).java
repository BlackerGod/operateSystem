...
public class Bank {
    ...
    private static  int KINDS=0;       //系统资源种类的个数
    private static  int[] resource;   //各个资源的总数
    private static  int ProcessCount;  //进程数量
    private static  List<Process> team;//这是一个装进程线性表的引用
    private static  int[] avaliable;  //系统当前可分配资源
    ...
    public static void InitProcess(){//初始化进程
        ...
        for(int i=0;i<ProcessCount;i++){
            Process newProcess=new Process();//每次创建一个新的进程对象，并对其初始化
											//并把它插入到顺序表中
